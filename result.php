...
<html lang="en">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Result Processing System</h2>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="panel">
                                            ...
                                            <p><b>Student Course: </b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>);
                                            <?php }
    ...
    ?>
<tr>
<th scope="row" colspan="2" style="text-align: center">Total Score</th>
...
<div class="alert alert-warning left-icon-alert" role="alert">
    <strong>Notice!</strong> Your result has not yet been declared...
 <?php }
?>
    </div>
 <?php 
